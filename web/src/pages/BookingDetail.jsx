    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 mb-5">
        <div className="flex items-start justify-between flex-wrap gap-4">
          ...
          <span
            className={`inline-flex items-center gap-1.5 text-sm font-semibold px-3 py-1.5 rounded-full border capitalize ${STATUS_COLOR[booking.status] || ''}`}
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-5">
          <h2 className="font-semibold text-gray-900 mb-4 flex items-center gap-2">
            <Car className="w-4 h-4 text-teal-500" /> Vehicle
          </h2>
          {car && (
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-5">
          <h2 className="font-semibold text-gray-900 mb-4 flex items-center gap-2">
            <MapPin className="w-4 h-4 text-teal-500" /> Locations
          </h2>
          <div className="space-y-3 text-sm">
            <div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-5">
          <h2 className="font-semibold text-gray-900 mb-4 flex items-center gap-2">
            <CreditCard className="w-4 h-4 text-teal-500" /> Payment
          </h2>
          ...
          <div className="text-sm space-y-1 text-red-600">
            ...
            {booking.refundAmount > 0 ? (
              <p className="font-medium">
                Refund: ₹{fmt(booking.refundAmount)} will be processed in 5–7 business days.
              </p>
            ) : (
      ...
      <div className="flex gap-3 mt-6">
        {canPay && (
          <Link
            ...
            className="bg-teal-500 text-white text-sm font-bold px-6 py-2.5 rounded-lg hover:bg-teal-600 transition-colors"
          >
            Complete Payment
          </Link>
        )}
